...
INSERT INTO `department` (`departmentID`, `departmentName`, `contractNumber`, `creationDate`, `updateDate`, `updatedByUser`) VALUES
(0, '', '', '2017-05-09 00:00:00', '2017-05-09 00:00:00', 1);
...
--
ALTER TABLE `billing`
  ADD CONSTRAINT `billing_ibfk_1` FOREIGN KEY (`departmentID`) REFERENCES `department` (`departmentID`) ON DELETE CASCADE ON UPDATE CASCADE;
