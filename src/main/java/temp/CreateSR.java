    ...
    private void initComponents() {
                ...
                .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlBillingCustomerLayout.createSequentialGroup()
                        .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblBillingContact, javax.swing.GroupLayout.DEFAULT_SIZE, 111, Short.MAX_VALUE)
                        ...
                        .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(pnlBillingCustomerLayout.createSequentialGroup()
                                ...
                                .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtBillingFax, javax.swing.GroupLayout.DEFAULT_SIZE, 148, Short.MAX_VALUE)))
        ...
        pnlBillingCustomerLayout.setVerticalGroup(
            ...
            .addGroup(pnlBillingCustomerLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtBillingPostalCode, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                    .addGroup(pnlBillingCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(pnlCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlCustomerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnlCustomerLayout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(txtPostalCode, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        pnlInfoLayout.setVerticalGroup(
            ...
            .addGroup(pnlInfoLayout.createSequentialGroup()
                .addGroup(pnlInfoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pnlBillingCustomer, javax.swing.GroupLayout.DEFAULT_SIZE, 326, Short.MAX_VALUE))
        ...
        pnlServiceLayout.setHorizontalGroup(
            ...
            .addGroup(pnlServiceLayout.createSequentialGroup()
                ...
                .addGroup(pnlServiceLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(rbEmergency, javax.swing.GroupLayout.DEFAULT_SIZE, 403, Short.MAX_VALUE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(pnlService, javax.swing.GroupLayout.DEFAULT_SIZE, 650, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(pnlSchedule, javax.swing.GroupLayout.DEFAULT_SIZE, 524, Short.MAX_VALUE)
                    .addComponent(pnlPayment, javax.swing.GroupLayout.DEFAULT_SIZE, 524, Short.MAX_VALUE)))
            .addGroup(layout.createSequentialGroup()
                .addGap(81, 81, 81)
    ...
    private void txtCustomerNameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCustomerNameKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER){
            if (CustomerType.equals("Existing")){
                try {
                    CustomerList = Operations.listCustomers("SELECT c.customerName, c.address FROM Customer c where c.customerName like '%" + txtCustomerName.getText() + "%'");
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            if (CustomerType.equals("Existing")){
                try {
                    ...
                    CustomerList = Operations.listCustomers("%" + txtAddress.getText() + "%");
                } catch (NamingException ex) {
                    Logger.getLogger(CreateSR.class.getName()).log(Level.SEVERE, null, ex);
                } catch (NotSupportedException ex) {
                    Logger.getLogger(CreateSR.class.getName()).log(Level.SEVERE, null, ex);
...
/**/
    ...
    public class MultipleRecords extends JFrame implements ActionListener{
        ...
        public void init()
        {
            ...
            for(Object obj : CustomerList){
                ...
                CustList.addItem(new_customer.getCustomerName()); //+ " | " + new_customer.getAddress());
            }
            AskPanel.add(BtnOK);
            DlgCntnr.add(AskPanel);
        ...
        public void actionPerformed(ActionEvent e1){
            ...
            if(e1.getSource() == BtnOK){
                try{
                    ...
                    my_customer = Operations.listCustomer("SELECT c.customerName, c.address FROM Customer c where c.customerName = '" + CustList.getSelectedItem().toString() + "'","");
                    //my_customer = Operations.listCustomer("customerName",CustList.getSelectedItem().toString());
                    //Billing my_billing = new Billing();
                    //my_billing = Operations.listBilling("billingId",my_customer.getBilling().getBillingId());
                    
                    //Customer 
                    //Customer new_customer = (Customer)session.get(Customer.class, Integer.getInteger(tokens[0]));
                    txtCustomerName.setText(my_customer.getCustomerName());
                    txtNotes.setText(my_customer.getNotes());
                    txtAddress.setText(my_customer.getAddress());
                    txtAddressNotes.setText(my_customer.getAddressNotes());
                    txtCity.setText(my_customer.getCity());
                    txtProvince.setText(my_customer.getProvince());
                    txtPostalCode.setText(my_customer.getPostalCode());
                    txtContactName.setText(my_customer.getContactName());
                    txtPrimaryPhone.setText(my_customer.getPrimaryPhone());
                    txtExt.setText(my_customer.getExt());
                    txtSecondaryPhone.setText(my_customer.getSecondaryPhone());
                    txtExt2.setText(my_customer.getExt2());
                    txtFax.setText(my_customer.getFax());
                    txtEmailAddress.setText(my_customer.getEmailAddress());
                    ...
                    txtBillingName.setText(my_customer.getBilling().getBillingName());
                    txtBillingAlias.setText(my_customer.getBilling().getBillingAlias());
                    txtBillingAddress.setText(my_customer.getBilling().getBillingAddress());
                    txtBillingCity.setText(my_customer.getBilling().getBillingCity());
                    txtBillingProvince.setText(my_customer.getBilling().getBillingProvince());
                    txtBillingPostalCode.setText(my_customer.getBilling().getBillingPostalCode());
                    txtBillingContactName.setText(my_customer.getBilling().getBillingContactName());
                    txtBillingPrimaryPhone.setText(my_customer.getBilling().getBillingPrimaryPhone());
                    txtBillingExt.setText(my_customer.getBilling().getBillingExt());
                    txtBillingFax1.setText(my_customer.getBilling().getBillingSecondaryPhone());
                    txtBillingExt2.setText(my_customer.getBilling().getBillingExt2());
                    txtBillingFax.setText(my_customer.getBilling().getBillingFax());
                    txtBillingEmailAddress.setText(my_customer.getBilling().getBillingEmailAddress());
                    System.out.println("Evrika");
                    //tx.commit();
    ...
    public void fillInfo(Customer new_customer){
        ...
        cmbBundles.setSelectedItem(new_customer.getBundles().getBundleName().toString());
