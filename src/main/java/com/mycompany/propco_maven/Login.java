...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblLogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/propco_maven/Picture1.png"))); // NOI18N
    ...
    private void returnResult(List resultList){
        ...
        for(Object obj : resultList){
            ...
            user_id = new_user.getUid();
            String user_name = new_user.getUserName();
            char[] ppaswd = txtPassword.getPassword();
            char [] dbpassArray = new_user.getPassword().toCharArray();
