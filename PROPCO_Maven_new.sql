...
--
-- Host: localhost
-- Generation Time: May 16, 2017 at 02:28 AM
...
INSERT INTO `billing` (`billingID`, `departmentID`, `billingName`, `billingAlias`, `billingAddress`, `billingCity`, `billingProvince`, `billingPostalCode`, `billingContactName`, `billingPrimaryPhone`, `billingExt`, `billingSecondaryPhone`, `billingExt2`, `billingFax`, `billingEmailAddress`, `tax`, `taxRate`, `creationDate`, `updateDate`, `updatedByUser`) VALUES
(0, 0, 'NO BUSINESS', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '2017-05-09', '2017-05-09', 1),
(1, 0, 'REGIONAL MUNICIPALITY OF DURHAM', '', '605 ROSSLAND RD E', 'WHITBY', 'ON', 'L1N 6A3', 'dudu', '', '', '', '', '', '', 'HST', '13.00', '0000-00-00', '2017-05-07', 1),
(2, 0, 'C/O GOLDVIEW PROPERTIES MANAGEMENT', 'VARIOUS LOCATIONS', '51 TORO RD # 200', 'TORONTO', 'ON', 'M6A 2E5', '', '', '', '', '', '', '', 'HST', '13.00', '0000-00-00', '0000-00-00', 1);
...
INSERT INTO `customer` (`customerID`, `billingID`, `bundleID`, `customerName`, `notes`, `address`, `addressNotes`, `city`, `province`, `postalCode`, `contactName`, `primaryPhone`, `ext`, `secondaryPhone`, `ext2`, `fax`, `emailAddress`, `creationDate`, `updateDate`, `updatedByUser`) VALUES
...
ALTER TABLE `customer`
  ...
  ADD CONSTRAINT `customer_ibfk_2` FOREIGN KEY (`bundleID`) REFERENCES `bundles` (`bundleID`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `serviceRequest`
  ...
  ADD CONSTRAINT `serviceRequest_ibfk_2` FOREIGN KEY (`serviceRequestNr`) REFERENCES `serviceRequestActivities` (`serviceReqNr`) ON DELETE CASCADE ON UPDATE CASCADE;
